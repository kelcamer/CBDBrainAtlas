...
export const REGIONS = [
  ...
  },
  {
    ...
    autismNote:
      'Basal-ganglia glutamate rises with both CBD and CBDV, in autistic and non-autistic people alike — that part isn’t autism-specific. What is autism-specific: CBDV normalises atypical caudate/putamen/accumbens hyperconnectivity toward the non-autistic pattern (Pretzsch 2021). Separately — in the prefrontal cortex, not the striatum itself — CBD’s effect on GABA reverses by diagnosis: it rises in non-autistic controls but falls in autistic adults (Pretzsch 2019).',
    sourceIds: [
