...
export const REGIONS = [
  ...
  },
  {
    ...
    autismNote:
      'Basal-ganglia glutamate rises with both CBD and CBDV, the same way in autistic and non-autistic people. What is autism-specific: CBDV normalises atypical caudate/putamen/accumbens hyperconnectivity toward the non-autistic pattern (Pretzsch 2021). Separately, in the prefrontal cortex (not the striatum): CBD decreases GABA in autistic adults and increases it in non-autistic adults (Pretzsch 2019).',
    sourceIds: [
