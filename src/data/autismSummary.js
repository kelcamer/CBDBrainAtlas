...
//
// cbdDirection — which way CBD moves activity/connectivity in this region,
// read off the same sources cited in `cbdFinding`. '▲' boosts, '▼' lowers,
// '↕' genuinely mixed (opposite directions across studies/subregions/doses —
// not just one big vs. one small effect), '—' tested with no significant
// effect, null when cbdStatus is 'gap' (nothing to point a direction at).
// ---------------------------------------------------------------------------
